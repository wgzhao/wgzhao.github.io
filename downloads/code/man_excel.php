 ...
 * then the directory must be existed on the system and have
 ...
 */
 ...
 {
 $this->error="Error : Another file is opend .Close it to save the
file";
 return false;
 } 
 ...
 if($this->fp==false)
 {
 $this->error="Error: Unable to open/create File.You may not have
permmsion to write the file.";
 return false;
 }
 $this->state="OPENED";
